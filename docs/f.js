...
async function extendRewards() {
	notice(`
		...
		Enter the amount of ${TEARNED[1]} you want to Donate as rewards to this Farmland. It will also extend the dry date by 8 days!<br><br>
...
async function notifyRewards() {
	...
	_T = new ethers.Contract(TEARNED[1],LPAB1,signer);
